...
def main(transport_test_env: bool = False):
    ...
    with LauncherBackEnd(args.transport_test, args.network_prefix) as be_server:
        try:
            be_server.run_startup(args.ip_addrs, args.host_ids, args.frontend_sdesc, level, fname, backend_ip_addr=args.backend_ip_addr, backend_hostname=args.backend_hostname)
